...
<body tableClass="role">
 <div id="search" style="margin-bottom: 10px; width: 100%">
  ...
  <div id="mm" style="width: 50%">
   ...
   <div data-options="name:'Description'">Description</div>
   <div data-options="name:'Principals'">Principals</div>
 ...
 <div id="dialog" style="display: none;">
  <form action="" method="post">
   <div>
    <h1 align="center" style="">角色详细信息</h1>
    <hr />
   </div>
   <div>
    <table align="center">
    <input id="ID" name="ID" type="hidden" isSubmit="1" />
      ...
      <tr>
           <td><font color="red">*</font><label>DESCRIPTION:</label>
               <input id="DESCRIPTION"  name="DESCRIPTION"  class="easyui-textbox" required="true" validType="username" isSubmit="1" style="width: 280px; height: 23px;" />
            </td>
          
      </tr>
      <tr>
           <td><font color="red">*</font><label>PRINCIPALS:</label>
               <input id="PRINCIPALS"  name="PRINCIPALS"  class="easyui-textbox" required="true" validType="username" isSubmit="1" style="width: 280px; height: 23px;" />
            </td>
 ...
 <div id="view" style="display: none;">
  <div>
   <h1 align="center" style="">Role详细信息</h1>
   <hr />
  </div>
  <div>
   <table align="center">
      ...
      <tr>
           <td><font color="red">*</font><label>DESCRIPTION:</label>
               ...
               <input id="DESCRIPTION"  name="DESCRIPTION"  readonly="readonly" isView="1" style="width: 280px; height: 23px;" />
            </td>
      ...
      <tr>
           <td><font color="red">*</font><label>PRINCIPALS:</label>
               ...
               <input id="PRINCIPALS"  name="PRINCIPALS"  readonly="readonly" isView="1" style="width: 280px; height: 23px;" />
            </td>
...
<script type="text/javascript" src="${cxt}/js/view/teacher/Role.js"></script>
