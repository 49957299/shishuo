...
<body tableClass="yhkxx">
	<div id="search" style="margin-bottom: 10px; width: 100%">
		...
		<div id="mm" style="width: 50%">
			...
			<div data-options="name:'Yhmc'">银行名称</div>
			<div data-options="name:'USERMC'">用户名称</div>

		</div>
	</div>
	<div id="dataGrid" class="easyui-datagrid" style="width: 100%; height: 450px"></div>
</body>
<script type="text/javascript" src="${cxt}/js/view/teacher/Yhyhkxx.js"></script>
