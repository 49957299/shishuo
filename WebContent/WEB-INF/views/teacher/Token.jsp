...
<body tableClass="token">
 <div id="search" style="margin-bottom: 10px; width: 100%">
  ...
  <div id="mm" style="width: 50%">
   ...
   <div data-options="name:'Ttl'">Ttl</div>
   <div data-options="name:'Userid'">Userid</div>
   <div data-options="name:'Createat'">Createat</div>
 ...
 <div id="dialog" style="display: none;">
  <form action="" method="post">
   <div>
    <h1 align="center" style="">Token详细信息</h1>
    <hr />
   </div>
   <div>
    <table align="center">
    <input id="ID" name="ID" type="hidden" isSubmit="1" />
      ...
      <tr>
           <td><font color="red">*</font><label>TTL:</label>
               <input id="TTL"  name="TTL"  class="easyui-textbox" required="true" validType="username" isSubmit="1" style="width: 280px; height: 23px;" />
            </td>
          
      </tr>
      <tr>
           <td><font color="red">*</font><label>USERID:</label>
               <input id="USERID"  name="USERID"  class="easyui-textbox" required="true" validType="username" isSubmit="1" style="width: 280px; height: 23px;" />
            </td>
          
      </tr>
      <tr>
          <td><font color="red">*</font><label>CREATEAT:</label>
          <input id="CREATEAT" name="CREATEAT" isSubmit="1" class="easyui-datetimebox" required="true" style="width: 280px; height: 23px;" />
          </td>
      </tr>
      <tr>
   ...
   <table align="center">
      ...
      <tr>
           <td><font color="red">*</font><label>TTL:</label>
               ...
               <input id="TTL"  name="TTL"  readonly="readonly" isView="1" style="width: 280px; height: 23px;" />
            </td>
      ...
      <tr>
           <td><font color="red">*</font><label>USERID:</label>
               ...
               <input id="USERID"  name="USERID"  readonly="readonly" isView="1" style="width: 280px; height: 23px;" />
            </td>
          
      </tr>
      <tr>
          <td><label>CREATEAT:</label>
          <input id="CREATEAT" name="CREATEAT"  readonly="readonly" isView="1" style="width: 280px; height: 23px;" />
          </td>
      </tr>
      <tr>
...
<script type="text/javascript" src="${cxt}/js/view/teacher/Token.js"></script>
