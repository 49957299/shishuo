...
public class PageInterceptor implements Interceptor {
	...
	public Object intercept(Invocation invocation) throws Throwable {
		...
		List<ParameterMapping> mappers = boundSql.getParameterMappings();
	 ...
	 *            当前的数据库连接
	 */
	private void setTotalRecord(HashMap map, MappedStatement mappedStatement, Connection connection) {
